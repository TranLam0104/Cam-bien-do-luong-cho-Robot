clear; clc; close all;
data_tho    = readmatrix('du_lieu_tho_mpu_dao_dong_qua_lai.txt');
data_bo_loc = readmatrix('du_lieu_bo_loc_mpu_dao_dong_qua_lai.txt');
...
hold off;
out_file = 'SoSanh_Tho_BoLoc_TotalAccel.png';
